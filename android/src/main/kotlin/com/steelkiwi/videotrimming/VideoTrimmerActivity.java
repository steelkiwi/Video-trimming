...
import com.steelkiwi.videotrimming.view.Utility;
import com.steelkiwi.videotrimming.view.customVideoViews.BackgroundTask;
import com.steelkiwi.videotrimming.view.customVideoViews.BarThumb;
import com.steelkiwi.videotrimming.view.customVideoViews.CustomRangeSeekBar;
import com.steelkiwi.videotrimming.view.customVideoViews.OnRangeSeekBarChangeListener;
import com.steelkiwi.videotrimming.view.customVideoViews.OnVideoTrimListener;
import com.steelkiwi.videotrimming.view.customVideoViews.TileView;
...
//        txtVideoEditTitle = (TextView) findViewById(R.id.txtVideoEditTitle);
        ...
        dstFile = new Date().getTime() + Utility.VIDEO_FORMAT;
    ...
    public void onClick(View view) {
        if (view == txtVideoCancel) {
            ...
            if (diff < 3) {
                ...
                BackgroundTask.execute(new BackgroundTask.Task("", 5L, "") {
                                           @Override
                                           public void execute() {
                                               try {
                                                   Utility.startTrim(file, dstFile, mStartPosition * 1000, mEndPosition * 1000, mOnVideoTrimListener,getApplicationContext());
