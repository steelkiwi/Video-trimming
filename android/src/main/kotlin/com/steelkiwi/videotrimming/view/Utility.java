package com.steelkiwi.videotrimming.view;
...
public class Utility {
    ...
    public static void startTrim(@NonNull File src, @NonNull String dst, long startMs, long endMs,
                                 @NonNull OnVideoTrimListener callback, Context context) throws IOException {
        final String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(new Date());
        ContextWrapper cw = new ContextWrapper(context);
        File directory = cw.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS);
        File file = new File(directory, dst);
        file.getParentFile().mkdirs();
        Log.d(TAG, "Generated file path " + file.getPath());
